...
<footer class="main-footer">
    <div class="float-right d-none d-sm-inline">
        Web Data Laporan Kontrol Lampu
    </div>
    <strong>Copyright &copy; 2021 <a href="<?php echo base_url('/'); ?>">Kontrol Lampu</a>.</strong> All rights reserved.
</footer>
</div>
...
<!-- Toastr -->
<script src="<?php echo base_url('public/assets/plugins'); ?>/toastr.min.js"></script>
<!-- DataTables  & Plugins -->
