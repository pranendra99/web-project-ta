...
<script>
    ...
    // Get Data
    firebase.database().ref('coba/post/').on('value', function (snapshot) {
    ...
    $('#submitStudent').on('click', function () {
        ...
        firebase.database().ref('coba/post/').push({
            nis: nis,
            name: name,
            age: age,
        });
    ...
    $('body').on('click', '.updateStudent', function () {
        ...
        firebase.database().ref('coba/post/' + updateID).on('value', function (snapshot) {
    ...
    $('.updateStudent').on('click', function () {
        ...
        var updates = {};
        updates['/coba/post/' + updateID] = postData;
    ...
    $('.deleteStudent').on('click', function () {
        ...
        firebase.database().ref('coba/post/' + id).remove();
